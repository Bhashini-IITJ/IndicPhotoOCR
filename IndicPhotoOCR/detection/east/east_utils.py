...
from IndicPhotoOCR.detection.east import east_config as cfg
from IndicPhotoOCR.detection.east import east_preprossing as preprossing
from IndicPhotoOCR.detection.east import east_locality_aware_nms as locality_aware_nms
